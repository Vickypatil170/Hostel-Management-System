            ...
            <div class="pricingwrapper">
                <div class="columns">
                    <ul class="price">
                        ...
                        <div class="imagewrapper">
                            <img style="height:150px; width:150px;" src="./assets/boys.jpg" alt="">
                        </div>
                        <li class="grey">10,000₹ per Semester</li>
                        <li>24*7 Wifi Service</li>
                        <li>Common Room with Television</li>
                        <li> Easy access to shop </li>
                ...
                <div class="columns">
                    <ul class="price">
                        ...
                        <div class="imagewrapper">
                            <img style="height:150px; width:150px;" src="./assets/girls.jpg" alt="">
                        </div>
                        <li class="grey">10,000₹ per Semester</li>
                        <li>24*7 Wifi Service</li>
                        <li>Common Room with Television</li>
